module.exports = ({defineError, getError, fetchErrors}) => {
    if (!getError('alert')) {
        ...
        defineError('channelNotFound', Alert, 'Missing utAlert.alert.ports.{port}.channel in the configuration');
        ...
        defineError('portNotFound', Alert, 'Missing utAlert.alert.ports.{port} in the configuration');
        defineError('portsNotFound', Alert, 'Missing utAlert.alert.ports in the configuration');
